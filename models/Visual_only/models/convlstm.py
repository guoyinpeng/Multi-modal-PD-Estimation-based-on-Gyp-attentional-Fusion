...
class ConvLSTM_AudioTransformer(nn.Module):
    def __init__(
        self,
        input_dim,
        output_dim,
        ...
        super(ConvLSTM_AudioTransformer, self).__init__()
        self.conv = ConvBlock1d(
            in_channels=input_dim,
            out_channels=conv_hidden,
            kernel=3,
...
class AudioCNNLSTMBaseline(nn.Module):
    def __init__(
        self,
        input_dim,
        output_dim,
...
class ConvLSTM_VisualBiLSTM(nn.Module):
    def __init__(
        self,
        input_dim,
        output_dim,
        ...
        super(ConvLSTM_VisualBiLSTM, self).__init__()
        self.conv = ConvBlock2d(
            in_channels=input_dim,
            out_channels=conv_hidden,
            kernel=(87, 3),
